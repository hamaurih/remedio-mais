...
const empty: any = {
  ...
  price_base: null, site_price: null, whatsapp_price: null, pdv_price: null,
  site_promo_price: null, whatsapp_promo_price: null, pdv_promo_price: null,
  use_channel_pricing: false, channel_price_notes: "",
  site_discount_percentage: null, whatsapp_discount_percentage: null, pdv_discount_percentage: null, lock_channel_discount: false,
};
  ...
  const save = async (keepOpen = false) => {
    try {
      ...
      const payload: any = {
        ...
        pdv_discount_percentage: toNumOrNull(editing.pdv_discount_percentage),
