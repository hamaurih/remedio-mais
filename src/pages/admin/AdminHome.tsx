...
const groups: Array<{ title: string; subtitle: string; modules: Module[] }> = [
  ...
  },
  {
    ...
    modules: [
      ...
      { title: "Clientes", description: "Clientes com histórico de pedidos, endereços e relacionamento.", to: "/admin/clientes", icon: Users },
      { title: "Cadastros do site", description: "Todas as contas criadas no e-commerce, inclusive quem ainda não comprou.", to: "/admin/cadastros", icon: UserPlus },
